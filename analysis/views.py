...
class IndexView(ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if 'relGenderCount' in rel_data:
            ...
            fratio1 = round(rel_data['relGenderCount']['f']['0-12']/sum_fage*100)
            fratio2 = round(rel_data['relGenderCount']['f']['13-19']/sum_fage*100)
            fratio3 = round(rel_data['relGenderCount']['f']['20-24']/sum_fage*100)
            fratio4 = round(rel_data['relGenderCount']['f']['25-29']/sum_fage*100)
            fratio5 = round(rel_data['relGenderCount']['f']['30-39']/sum_fage*100)
            fratio6 = round(rel_data['relGenderCount']['f']['40-49']/sum_fage*100)
            fratio7 = round(rel_data['relGenderCount']['f']['50-']/sum_fage*100)
            fage = list()
            fage.append(fratio1)
            fage.append(fratio2)
            fage.append(fratio3)
            ...
            mratio1 = round(rel_data['relGenderCount']['m']['0-12']/sum_mage*100)
            mratio2 = round(rel_data['relGenderCount']['m']['13-19']/sum_mage*100)
            mratio3 = round(rel_data['relGenderCount']['m']['20-24']/sum_mage*100)
            mratio4 = round(rel_data['relGenderCount']['m']['25-29']/sum_mage*100)
            mratio5 = round(rel_data['relGenderCount']['m']['30-39']/sum_mage*100)
            mratio6 = round(rel_data['relGenderCount']['m']['40-49']/sum_mage*100)
            mratio7 = round(rel_data['relGenderCount']['m']['50-']/sum_mage*100)
            mage = list()
            mage.append(mratio1)
            mage.append(mratio2)
            mage.append(mratio3)
